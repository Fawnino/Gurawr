...
module.exports = {
  name: 'add',
  aliases: ['addition'], // If u do !add 10 10 or !addition 10 10  it would work
  description: 'Adds numbers', // This is not important but u can add it if u want
  usage: '<num1> <num2>',
  args: 1, // This is the syntax, so if u do: !add 1 1 1 or !add 1 | it will mention this syntax
async execute(message, args){ // The message and args mentioned here will become parameters and bascially below is the function of ur commands
    ...
    if(isNaN(numbers)) {
      return message.channel.send(':negative_squared_cross_mark: | Use numbers piece of shit')
    }
