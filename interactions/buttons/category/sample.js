...
module.exports = {
  ...
  async execute(client, interaction, args) {
    ...
    let row = new MessageActionRow().addComponents(
      new MessageButton()
        .setURL(
          "https://discord.com/api/oauth2/authorize?client_id=885002893671927848&permissions=8&redirect_uri=https%3A%2F%2Fdiscord.events.stdlib.com%2Fdiscord%2Fauth%2F&scope=bot%20applications.commands"
        )
        .setLabel("Invite Me")
        .setStyle("LINK"),
